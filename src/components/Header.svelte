...
<nav class="fixed w-full md:relative z-50 lg:relative px-4 py-4 flex justify-between items-center bg-white">
  ...
  <ul class="flex flex-col md:flex-row md:mx-6 bg-gray-100 rounded-md">
    <li>
      <Link to="/" on:click={toggleoffCv} class="flex items-center px-4 py-4 rounded hover:bg-gray-200 transition-colors duration-200">
    ...
    <li>
      <Link to="projects" on:click={toggleoffCv} class="flex items-center px-4 py-4 rounded hover:bg-gray-200 transition-colors duration-200">
    ...
    <li>
      <Link to="services" on:click={toggleoffCv} class="flex items-center px-4 py-4 rounded hover:bg-gray-200 transition-colors duration-200">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
