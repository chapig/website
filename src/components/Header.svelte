...
<nav class="fixed w-full md:relative z-50 lg:relative px-4 py-4 flex justify-between items-center bg-white md:bg-white lg:bg-white">
  ...
  <div class="lg:hidden md:hidden">
    <button on:click={toggle} class="navbar-burger flex items-center text-black bg-yellow-400 rounded p-3">
...
<div class="navbar-menu relative z-50" transition:fade="{{delay: 250, duration: 300}}">
  ...
  <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 overflow-y-auto bg-yellow-400">
    ...
    <div>
      <ul>
        <li class="mb-1">
          <Link to="services" class="flex items-center px-4 py-2 text-gray-800 bg-gray-100 rounded-md hover:bg-white hover:text-black">
        ...
        <li class="mb-1">
          <Link to="cv" class="flex items-center px-4 py-2 text-gray-800 bg-gray-100 rounded-md hover:bg-white hover:text-black">
