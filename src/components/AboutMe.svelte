<script>
    let owner = {
        firstname: 'Luis',
        lastname: 'C. Gómez',
        bio: 'Soy programador, políglota y TSU en idiomas mención inglés. Me encanta la informática, jugar videojuegos y cantar.'
    };
</script>
...
<section class="bg-transparent">
    <div class="container px-6 py-8 mx-auto">
        <div class="items-center lg:flex">
            <div class="lg:w-1/2">
                <h2 class="text-2xl font-bold text-white">Quién soy</h2>

                <p class="mt-4 text-gray-200 dark:text-gray-400 lg:max-w-md">
                    Mi nombre es <span class="font-bold">{@html owner.firstname} {@html owner.lastname}.</span> {@html owner.bio}
                </p>
